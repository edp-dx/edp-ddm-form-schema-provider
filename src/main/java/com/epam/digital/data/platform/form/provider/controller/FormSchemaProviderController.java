...
public class FormSchemaProviderController {
  ...
  private final FormSchemaProviderService formSchemaProviderService;

  @Autowired
  public FormSchemaProviderController(FormSchemaProviderService formSchemaProviderService) {
    this.formSchemaProviderService = formSchemaProviderService;
  }

  // ... existing methods ...

  @GetMapping("/cards/visible")
  public List<FormSchema> getVisibleCards() {
    Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
    return formSchemaProviderService.getVisibleCardsForUser(authentication);
  }
}
