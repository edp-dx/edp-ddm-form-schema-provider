...
import com.epam.digital.data.platform.form.provider.entity.FormSchema.FormType;
...
public interface FormRepository extends KeyValueRepository<FormSchema, String> {
  ...
  List<FormSchema> findFormSchemasByTypeAndShowCardOnUi(FormType type, boolean showCardOnUi);
}
